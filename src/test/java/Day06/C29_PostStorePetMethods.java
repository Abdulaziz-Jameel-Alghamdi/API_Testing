...
public class C29_PostStorePetMethods extends petStoreBaseUrl {
...
//(All actions must be done on same pet)
    ...
    public void createPetTest() {
        ...
        PetStoreResponse payload2 = new PetStoreResponse(urls, "Aldo", id, category, tags, "available");


        // Send Request and Get Response
        Response response = given(spes).body(payload2).when().post("{first}");
    ...
    public void updatePetTest() {
        ...
        // Send Request and Get Response
        Response response = given(spes).body(payload).put("{first}");
        response.prettyPrint();
    ...
    public void deletePetTest() {
        spes.pathParams("first", "pet", "second", id);
