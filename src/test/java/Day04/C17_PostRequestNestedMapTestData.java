...
public class C17_PostRequestNestedMapTestData extends JsonPlaseHolderBaseUrl {
 ...
 */
    ...
    public void postNestedMapTest() {
        ...
        Map<String, Object> payLoad = RestfulTestData.bookingMapper("John", "Doe", 15, true, bookingdates, "Lunch");
